...
- [Script Recording](#script-recording)
...
1. Run **WebCure: Start Recording** from the Command Palette
2. Interact with the browser (click, type, navigate, etc.)
3. Run **WebCure: Stop Recording**

When recording stops, a new untitled Python script opens in your editor with the recorded actions converted to Python code.
...
├── tests/
│   ├── MANUAL-TEST-RESULTS.md  # Manual test documentation (69 tests)
│   ├── bridge-integration-tests.sh  # Automated bridge integration tests
│   └── unit/
│       └── tools.test.ts     # Unit tests for bridge routing & param transforms
├── status/
│   └── project_status_01.md  # Project status report
