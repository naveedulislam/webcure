...
3. Perform browser actions — navigate, click, type, resize, etc. using any WebCure command
4. Run **WebCure: Stop Recording**
...
click("Sign In")
type_text("admin", into="Username")
type_text("admin", into="Password")
click("Login")
```
